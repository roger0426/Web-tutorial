...
function create() {
  ...
  this.anims.create({ frameRate: 350, frames: this.anims.generateFrameNumbers('dude', { start: 0, end: 3 }), key: 'left', repeat: -1 })
  this.anims.create({ frameRate: 20, frames: [ { key: 'dude', frame: 4 } ], key: 'turn', })
  this.anims.create({ frameRate: 350, frames: this.anims.generateFrameNumbers('dude', { start: 5, end: 8 }), key: 'right', repeat: -1 })
  ...
  stars = this.physics.add.group({ key: 'star', repeat: 100, setXY: { x: 12, y: 0, stepX: 7 } })
